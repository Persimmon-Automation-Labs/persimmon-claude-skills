---
name: quality-review-data-layer
...
Prisma + Postgres + pgvector audit. Runs standalone or via `quality-final-review`.
...
## Integration with `quality-final-review`

Return JSON: `{ "skill": "review-data-layer", "counts": {...}, "findings": [...] }`. Data-layer FAIL is the earliest signal — `quality-final-review` should surface these first, since they often cause build-time or runtime crashes that mask other findings.
