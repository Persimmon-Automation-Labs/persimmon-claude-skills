...
- **stack-server-actions** — calls `auth()` inside actions
- **stack-zod-boundary** — schema for `authorize()` input
- **data-prisma-pgvector** — the `db` instance this skill uses
- **stack-typescript-strict** — session type augmentation
