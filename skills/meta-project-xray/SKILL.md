...
**When NOT to use**:
- If the user wants a code review (use `quality-final-review` or review-specific skills)
...
_Last updated: {date}. Regenerate via `meta-project-xray` skill when architecture changes._
