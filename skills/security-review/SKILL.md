...
Security audit tailored to the Persimmon default stack: Next.js 16 (App Router), Prisma, NextAuth v5, Tigris/S3, Anthropic Claude. Runs standalone or via the `quality-final-review` orchestrator.
