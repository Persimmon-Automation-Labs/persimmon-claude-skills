...
- **stack-server-actions** — how retrieval is called from a brief-generation action
- **stack-zod-boundary** — validating query text before embedding
- **stack-typescript-strict** — branded types for `ChunkId`, `DocumentId`
