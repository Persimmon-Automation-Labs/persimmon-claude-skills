...
- `ai-prompt-library` — where every prompt built with these rules lives.
- `legal-brief-composer` — the composition pipeline that depends on this register.
- `legal-pdf-classifier` — also uses pt-BR prompts, in a lighter register for summaries.
